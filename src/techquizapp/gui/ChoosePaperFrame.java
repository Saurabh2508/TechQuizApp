...
public class ChoosePaperFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGiveTest = new javax.swing.JButton();
        ...
        btnGiveTest.setBackground(new java.awt.Color(0, 0, 0));
        btnGiveTest.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnGiveTest.setForeground(new java.awt.Color(255, 0, 0));
        btnGiveTest.setText("Give The Test");
        btnGiveTest.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGiveTestActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jcExamId, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnGiveTest))
    ...
    private void jcLanguageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcLanguageActionPerformed
        ...
        try
        {
            ...
            if(examList.isEmpty())
            {
                 JOptionPane.showMessageDialog(null, "You have already appeared for all exam of "+subjectName, "No Paper Remaining",JOptionPane.INFORMATION_MESSAGE);
                 return;
            }
    ...
    private void btnGiveTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGiveTestActionPerformed
       boolean result=validateInput();
        if(!result)
        {
            JOptionPane.showMessageDialog(null, "Please select a subject", "Error!",JOptionPane.ERROR_MESSAGE);
        ...
        if(ans==JOptionPane.YES_OPTION)
        {
            try
            {
                ...
                GiveTestFrame giveTest=new GiveTestFrame(exam);
                giveTest.setVisible(true);
                this.dispose();
            }
            catch(SQLException ex)
            {
    ...
    }//GEN-LAST:event_btnGiveTestActionPerformed
    ...
    private javax.swing.JButton btnGiveTest;
